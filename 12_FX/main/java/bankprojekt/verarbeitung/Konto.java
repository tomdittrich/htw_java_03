...
public abstract class Konto implements Serializable {
    ...
    protected void setKontostand(double kontostand) {
        this.derKontostand.set(kontostand);
    }

    public ReadOnlyDoubleProperty derKontostandProperty()
    {
        return this.derKontostand.getReadOnlyProperty();
    }
    ...
    public String toString() {
        ...
        ausgabe += "Aktueller Kontostand: " + this.derKontostand.get() + " Euro ";
    ...
    public void waehrungswechsel(Currency neu) {
        ...
        setKontostand((derKontostand.get() / valuta.getRate()) * neu.getRate()); // Converts
