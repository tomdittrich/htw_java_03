...
/**
 * stellt eine analoge uhrwerk dar
 * 
 * @author Doro
 *
 */
public class KreisUhr extends JFrame implements Observer
{
	...
	/**
	 * erstellt die analoge uhrwerk und bringt sie auf den Bildschirm
	 */
	public KreisUhr(UhrController u, Uhr uh) {
		...
		// Einrichten des KeyListeners, d.h. die uhrwerk reagiert auf Tastendruck
		this.addKeyListener(new KeyAdapter() {

			/**
			 * Taste 'E' schaltet die uhrwerk ein, 'A' schaltet sie aus, alle
